...
class Theme {
    constructor() {
        this.primaryColor = 'var(--mermaid-css-primary-color)';
        this.contrast = 'var(--mermaid-css-contrast)';
        this.secondaryColor = 'var(--mermaid-css-contrast)';
        lighten(this.contrast, 55);
